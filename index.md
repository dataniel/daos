...
| [`statbank_app()`](https://dataniel.github.io/daos/reference/statbank_app.md) | Shiny explorer for the Greenland Statbank: search, select, preview, and copy R code |
| [`statbank_get()`](https://dataniel.github.io/daos/reference/statbank_get.md) | Download a Greenland Statbank table as a tidy tibble |
