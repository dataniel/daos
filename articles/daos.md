...
Four functions form a pipeline for fetching published annual reports
from Erhvervsstyrelsens distribution service: build the query, send it,
extract the hits, download the documents. Requires `curl` and
`jsonlite`.
